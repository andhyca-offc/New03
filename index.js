...
module.exports = chika = async (chika, m, chatUpdate, store) => {
    try {
        ...
        // Fake
        const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumb, surface: 200, message: `${footer}`, orderTitle: '𝚂𝚑𝚒𝚛𝚘-𝙼𝙳 ( P U B L I C )', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${footer}`,jpegThumbnail: thumb}}}
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":`${footer}`, "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `${footer}`, 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "https://chat.whatsapp.com/LMXN8ZkUmvfHGsURriEJOE","inviteCode": "m","groupName": "𝚂𝚑𝚒𝚛𝚘-𝙼𝙳 ( P U B L I C )", "caption": `${footer}`, 'jpegThumbnail': thumb}}}
		...
		const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `${footer}`,jpegThumbnail: thumb}}}
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await chika.setStatus(`${footer} | Runtime : ${runtime(uptime)}`)
...
┗━═┅═━––––––๑`
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) chika.sendText(m.chat, `┌ 「 *I N F O* 」\n│• Waktu Suit Telah Habis\n❐────────`, m)
            delete this.suit[id]
		...
		db.data.users[m.sender].limit -= 1 // -1 limit
                if ('family100'+m.chat in _family100) {
                    reply('*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !')
                    throw false
                }
                let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/family100.json')
                let random = anu[Math.floor(Math.random() * anu.length)]
                let hasil = `❏––––––『 *F A M 1 0 0︎* 』––––––\n┆\n┆✦ Jawablah Pertanyaan Berikut :\n┆ ${random.soal}\n┆ Terdapat *${random.jawaban.length}*\n┆✦ Jawaban ${random.jawaban.find(v => v.includes(' ')) ? `(beberapa Jawaban Terdapat Spasi)\n┆\n┗━═┅═━––––––๑` : ''}`.trim()
            ...
            case 'tebak': {
            	 if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
		        db.data.users[m.sender].limit -= 1 // -1 limit
                if (!q) return reply(`❏––––––『 *T E B A K* 』––––––\n┆\n┆✦ Example : ${prefix + command} lagu\n┆✦ Option : \n┆• ${prefix}tebak lagu\n┆• ${prefix}tebak gambar\n┆• ${prefix}tebak kata\n┆• ${prefix}tebak kalimat\n┆• ${prefix}tebak lirik\┆• ${prefix}tebak lontong\n┆\n❐────────`)
                if (args[0] === "lagu") {
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    let anu = await fetchJson('https://fatiharridho.github.io/tebaklagu.json')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    let msg = await chika.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    chika.sendText(m.chat, `❏––––––『 *L A G U* 』––––––\n┆\n┆✦ Lagu Tersebut Adalah Lagu dari?\n┆✦ Artist : ${result.artist}\n┆\n┆✦Waktu : 60s\n┗━═┅═━––––––๑`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: '🎶 Tebak Lagu' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${tebaklagu[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'gambar') {
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: '🖼️ Tebak Gambar' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${tebakgambar[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkata.json')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    chika.sendText(m.chat, `❏––––––『 *K A T A* 』––––––\n┆\n┆✦ Silahkan Jawab Pertanyaan Berikut\n┆• ${result.soal}\n┆\n┆✦ Waktu : 60s\n┗━═┅═━––––––๑`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: '🔠 Tebak Kata' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${tebakkata[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kalimat') {
                    if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkalimat.json')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    chika.sendText(m.chat, `❏––––––『 *K A L I M A T* 』––––––\n┆\n┆✦ Silahkan Jawab Pertanyaan Berikut\n┆• ${result.soal}\n┆\n┆✦ Waktu : 60s\n┗━═┅═━––––––๑`, m).then(() => {
                    tebakkalimat[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: '💬 Tebak Kalimat' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${tebakkalimat[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'lirik') {
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaklirik.json')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    chika.sendText(m.chat, `❏––––––『 *L I R I K* 』––––––\n┆\n┆✦ Ini Adalah Lirik Dari Lagu? :\n┆• *${result.soal}*?\n┆\n┆✦ Waktu : 60s\n┗━═┅═━––––––๑`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: '🎼 Tebak Lirik' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${tebaklirik[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'lontong') {
                    if (caklontong.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
                    let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/caklontong.json')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    chika.sendText(m.chat, `❏––––––『 *L O N T O N G* 』––––––\n┆\n┆✦ Jawablah Pertanyaan Berikut :*\n┆• ${result.soal}*\n┆\n┆✦ Waktu : 60s\n┆\n┗━═┅═━––––––๑`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    chika.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: '❓ Tebak Lontong' }, type: 1 }], `┌ 「 *I N F O* 」\n│• Waktu Telah Habis\n│ Jawaban : ${caklontong[m.sender.split('@')[0]]}\n│ Deskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n├ 𖣘 Ingin bermain lagi? tekan button dibawah\n❐────────`, footer, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            case 'kuismath': case 'math': {
                if (kuismath.hasOwnProperty(m.sender.split('@')[0])) throw "*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Masih Ada Sesi Yang Belum Diselesaikan !"
            ...
            let jawab = `❏––––––『 *J O D O H K U* 』––––––
┆
┆✦ Jodoh Mu Adalah ☟︎︎︎
┆• @${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}
┆
┆✦ Selamat Untuk Kamu 💖, Jangan Lupa Pajak Jadian-Nya Yah😘
┗━═┅═━––––––๑`
            let ments = [me, jodoh]
            let buttons = [
                        { buttonId: 'jodohku', buttonText: { displayText: 'Jodohku' }, type: 1 }
                    ]
                    await chika.sendButtonText(m.chat, buttons, jawab, footer, m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) return reply(mess.group)
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `❏––––––『 *J A D I A N* 』––––––
┆
┆• @${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}
┆
┆✦ Selamat Untuk Kalian Berdua 💖, Jangan Lupa Pajak Jadian-Nya Yah😘
┗━═┅═━––––––๑`
            let menst = [orang, jodoh]
            let buttons = [
                        { buttonId: 'jadian', buttonText: { displayText: '🌷 Jadian' }, type: 1 }
                    ]
                    await chika.sendButtonText(m.chat, buttons, jawab, footer, m, {mentions: menst})
            }
            break
            case 'apakah':
...
chika.sendMessage(from, { text: `❏––––––『 *A P A K A H* 』––––––\n┆✦ Pertanyaan : Apakah ${q}\n┆✦ Jawaban : ${kah}` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *B I S A K A H* 』––––––\n┆✦ Pertanyaan : ${q}\nJawaban : ${ga}` }, { quoted: m })

					break
case 'bagaimanakah':
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
					const gimana = ['Gak Gimana2', 'Sulit Itu Bro', 'Maaf Bot Tidak Bisa Menjawab', 'Coba Deh Cari Di Internet','astaghfirallah Beneran???','Pusing ah','Owhh Begitu:(','Yang Sabar Ya Bos:(','Gimana yeee']
					const ya = gimana[Math.floor(Math.random() * gimana.length)]
chika.sendMessage(from, { text: `❏––––––『 *G I M A N A* 』––––––\n┆✦ Pertanyaan : ${q}\n┆✦ Jawaban : ${ya}` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *R A T E* 』––––––\n┆✦ Rate : ${q}\n┆✦ Jawaban : *${te}%*` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *G A N T E N G* 』––––––\n┆✦ Nama : ${q}\n┆✦ Jawaban : *${teng}%*` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *C A N T I K* 』––––––\n┆✦ Nama : ${q}\n┆✦ Jawaban : *${tik}%*` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *L E S B I & G A Y* 』––––––\n┆✦ Nama : ${q}\n┆✦ Jawaban : *${sange}%*` }, { quoted: m })
...
chika.sendMessage(from, { text: `❏––––––『 *K A P A N K A H* 』––––––\n┆✦ Pertanyaan : ${q}\n┆✦ Jawaban : *${kapankah}*` }, { quoted: m })
					break
case 'wangy':
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            if (!(m.chat in vote)) throw `_*tidak ada voting digrup ini!*_\n\n*${prefix}vote* - untuk memulai vote`
            delete vote[m.chat]
            reply('𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Berhasil Menghapus Sesi Vote Di Grup Ini')
	    }
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await chika.sendButtonText(m.chat, buttons, `Mode Group`, footer, m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await chika.sendButtonText(m.chat, buttons, `Mode Edit Info`, footer, m)
            ...
            case 'antilink': {
                ...
                reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await chika.sendButtonText(m.chat, buttons, `Mode Antilink`, footer, m)
                }
             }
             break
             case 'mute': {
                ...
                reply(`${ownername} telah di unmute di group ini !`)
                 ...
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: '⊶ Enable' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: '⊷ Disable' }, type: 1 }
                    ]
                    await chika.sendButtonText(m.chat, buttons, `Mute Bot`, footer, m)
                }
             }
             break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      chika.send5ButImg(i, txt, footer, global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      chika.send5ButImg(yoi, txt, footer, global.thumb, btn)
		}
...
case 'webtonsearch': case 'webtoon':
            ...
            case 'anime':{
				...
				await chika.send5ButLoc(from, txt , `${footer}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(mess.error)
                })
...
await chika.send5ButImg(from, `⭔ _*Title :*_ ${cerpe.title}\n⭔ _*Author :*_ ${cerpe.author}\n⭔ _*Category :*_ ${cerpe.kategori}\n⭔ _*Pass Moderation :*_ ${cerpe.lolos}\n⭔ _*Story :*_\n${cerpe.cerita}`, ` ${footer}`, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}}] )
}
break
case 'fajar-news':
reply(mess.wait)
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    break
	    case 'anonymous': {
                if (m.isGroup) return reply('*𝗔𝗖𝗖𝗦𝗘𝗦𝗦 𝗔𝗥𝗘 𝗗𝗘𝗡𝗜𝗘𝗗* 〄\n *ᴄᴏᴍᴍᴀɴᴅ* • Fitur ini Tidak bisa di Akses Di Group !')
				this.anonymous = this.anonymous ? this.anonymous : {}
				let buttons = [
                    { buttonId: 'start', buttonText: { displayText: 'Start' }, type: 1 }
                ]
                chika.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await chika.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, footer, m)
            }
			break
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await chika.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, footer, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await chika.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, footer, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await chika.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, footer, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await chika.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, footer, m)
                }
                break
            }
...
const templateMessage = {
text: 'Tuh Kak Owner Ku',footer: `© ${footer}`,
templateButtons: [
{
index: 1, 
urlButton: {
...
break
case 'command': {
await chika.sendListMenu(from, `*––––––『 LIST MENU 』––––––*\n✦ ✧\n┬ *Good ${salam}*\n│• *Name:* ${pushname}\n│• *Limit:* limitUser\n│• *Status:* isPremium\n┗━━━━━━━━━━━━━━━┈─✥` , lang.list(pushname) , 'CLICK HERE ⎙', {quoted: fkontak})
}
break
case 'menu': {
if(typemenu == 'image'){
...
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.menu(botname, pushname, salam), `${footer}`,velochika, [{"urlButton": {"displayText": "📽️ YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `🎀 Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "🌹 Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "🌸 List Menu","id": 'command'}}] )
}
if(typemenu == 'list'){
...
await chika.send5ButImg(from, `` + '' + lang.allmenu(prefix, pushname, limitUser, botname, time, wit, wita, salam), `${footer}`,velochika, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
}
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.allmenu(prefix, pushname, limitUser, botname, time, wit, wita, salam), `${footer}`,velochika, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
}
if(typemenu == 'catalog'){
...
await chika.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'downloadermenu':
var riych = await getBuffer(picak+'Downloader Menu')
await chika.send5ButImg(from, `` + '' + lang.downloadermenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'telestickmenu':
var riych = await getBuffer(picak+'Telegram Sticker Menu')
await chika.send5ButImg(from, `` + '' + lang.telestickmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'randommenu':
var riych = await getBuffer(picak+'Random Menu')
await chika.send5ButImg(from, `` + '' + lang.randommenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'randomanimemenu':
var riych = await getBuffer(picak+'Random Anime Menu')
await chika.send5ButImg(from, `` + '' + lang.randomanimemenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
...
await chika.send5ButImg(from, `` + '' + lang.textpromenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'photooxymenu':
var riych = await getBuffer(picak+'Photo Oxy Menu')
await chika.send5ButImg(from, `` + '' + lang.photooxymenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'ephotomenu':
var riych = await getBuffer(picak+'Ephoto Menu')
await chika.send5ButImg(from, `` + '' + lang.ephotomenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'funmenu':
var riych = await getBuffer(picak+'Fun Menu')
await chika.send5ButImg(from, `` + '' + lang.funmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'primbonmenu':
var riych = await getBuffer(picak+'Primbon Menu')
await chika.send5ButImg(from, `` + '' + lang.primbonmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'cerpenmenu':
var riych = await getBuffer(picak+'Cerpen Menu')
await chika.send5ButImg(from, `` + '' + lang.cerpenmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'convertmenu':
var riych = await getBuffer(picak+'Converter Menu')
await chika.send5ButImg(from, `` + '' + lang.convertmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'informationmenu':
var riych = await getBuffer(picak+'Information Menu')
await chika.send5ButImg(from, `` + '' + lang.informationmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'mainmenu':
var riych = await getBuffer(picak+'Main Menu')
await chika.send5ButImg(from, `` + '' + lang.mainmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'databasemenu':
...
await chika.send5ButImg(from, `` + '' + lang.anonymousmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'islamicmenu':
var riych = await getBuffer(picak+'Islamic Menu')
await chika.send5ButImg(from, `` + '' + lang.islamicmenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'voicechargermenu':
var riych = await getBuffer(picak+'Voice Charger Menu')
await chika.send5ButImg(from, `` + '' + lang.voicechargermenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'ownermenu':
var riych = await getBuffer(picak+'Owner Menu')
await chika.send5ButImg(from, `` + '' + lang.ownermenu(prefix), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'donasi': case 'donate':
var riych = await getBuffer(picak+'Donasi')
await chika.send5ButImg(from, `` + '' + lang.donasi(ownernomer), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'thanksto': case 'tqto':
var riych = await getBuffer(picak+'Contributors')
await chika.send5ButImg(from, `` + '' + lang.thanksto(), `${footer}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
             default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
